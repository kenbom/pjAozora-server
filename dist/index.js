    ...
    context: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log("atIndexReqHeader:".concat(JSON.stringify(req.headers)));
                        return [4, (0, getUserFromToken_1.getUserFromToken)(req.headers.authorization)];
                    case 1:
                        userInfo = _b.sent();
                        return [2, {
...
server.listen({ port: process.env.PORT || 4000 }).then(function (_a) {
    var url = _a.url;
    console.log("Server ready on ".concat(url));
});
